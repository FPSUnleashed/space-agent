...
- the runtime prompt also appends the current admin skill catalog built from top-level readable `mod/*/*/ext/skills/*/SKILL.md` files discovered with `maxLayer=0`, filtered by the current document's `<x-context>` tags
