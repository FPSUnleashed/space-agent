...
- the workflow runs on pushed `v*` tags
- it publishes desktop artifacts only when the tag points at `main` HEAD
...
- every tagged release rebuilds and uploads fresh desktop artifacts to the new release
